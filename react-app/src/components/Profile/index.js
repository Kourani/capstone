...
export default function Profile(){
    ...
    return (
        ...
        <div className='newProfile'>
            {todayDay === day && todayMonth === month ? `Happy Birthday! ${userState.user.firstName} ${userState.user.lastName} ${balloons()}` : `Welcome Back ${userState.user.firstName} ${userState.user.lastName}` }
