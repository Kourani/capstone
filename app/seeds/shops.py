...
def seed_shops():
    ...
    shop3 = Shop(
        owner_id = 3, address='6743 Nepal', city='Mumbai', state='Assam', country='United States', name='Spice Land', currency='Rupee', image="https://images.pexels.com/photos/715134/pexels-photo-715134.jpeg")
