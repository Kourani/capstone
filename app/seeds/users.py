...
def seed_users():
    demo = User(
        profile_icon='https://images.pexels.com/photos/1460836/pexels-photo-1460836.jpeg', first_name = 'Demo' , last_name = 'Lition' , about = 'I love anything vintage' , birthday = '11/13/01' , address = '555 Disney Lane' , city = 'Dearborn' , state = 'Texas' , country = 'United States' , username='Demo', email='demo@aa.io', password='password')
    maria = User(
